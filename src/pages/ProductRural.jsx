        ...
        <div className="wrapper">
            ...
            <div className="contentProduct2 ">
                ...
                <div className="block-productsProduct">
                    ...
                    <div className="products">
                        <div className="rectangle-products">
                            <img className="product-img" src={img10Rural } alt="" />
                        </div>
                        <div className="txt-products">
                            <div className="text-serif16m _h57">1С:Предприятие 8. Лесозавод</div>
                            <div className="roboto-reg13">«1С:Предприятие 8. Лесозавод» предназначено для автоматизации управления и учета на предприятиях лесопромышленного комплекса</div>
                            <div className="btn-txt">
                                <div className="roboto-medium13"> Приобрести</div>
                                <button className="bbtn">
                                    <div className="text-serif13m">Подробнее</div>
